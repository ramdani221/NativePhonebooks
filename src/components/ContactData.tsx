        ...
        return (
            <View style={style.dataBox}>
                ...
                <View style={style.identity}>
                    <View>
                        <TextInput style={style.input} defaultValue={newData.name} onChangeText={newText => setNewData({ ...newData, name: newText })} />
                    </View>
                    <View>
                        <TextInput style={style.input} defaultValue={newData.phone} onChangeText={newText => setNewData({ ...newData, phone: newText })} />
                    </View>
            ...
            <View style={style.dataBox}>
                ...
                <View style={style.identity}>
                    ...
                    <View style={style.identityBtn}>
                        ...
                        <TouchableOpacity onPress={() => dispatch(deleteContact(contact.id))}>
